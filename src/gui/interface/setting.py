...
class SettingInterface(ScrollArea):
    ...
    def init_UI(self):
        ...
        self.when_close_window_card = ComboBoxSettingCard(config.when_close_window, ExtendedFluentIcon.EXIT, self.tr("When closing window"), self.tr("What should the program do when you close the window"), [self.tr("Exit the program"), self.tr("Minimize to system tray"), self.tr("Always ask")], self)
