...
from utils.tools import get_header, get_proxy, get_auth, get_exclimbwuzhi_header, get_login_header
...
class LoginBase:
    ...
    def ExClimbWuzhi(self, _5062: str, _df35: str, _39c8: str):
        ...
        self.session.post(url, json = payload, headers = get_exclimbwuzhi_header(), proxies = get_proxy(), auth = get_auth())
...
class CaptchaUtils:
    ...
    def get_geetest_challenge_gt(self):
        req = requests.get("https://passport.bilibili.com/x/passport-login/captcha?source=main-fe-header&t=0.1867987009754133", headers = get_header(), proxies = get_proxy(), auth = get_auth())
