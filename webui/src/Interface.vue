    ...
    <div class="main-interface" :class="themeStore.theme">
        ...
        <div class="main-content">
            <navigationBar :active-index="activeNavIndex">
                <navigationBarButton :title="t('nav.parse')" icon="/src/assets/icon/search.svg" to="/parse" />
                <navigationBarButton :title="t('nav.download')" icon="/src/assets/icon/download.svg" to="/download" />
                <navigationBarStretch />
                <navigationBarButton :title="t('nav.settings')" icon="/src/assets/icon/settings.svg" to="/settings" />
            </navigationBar>
            <navigationPanel>
